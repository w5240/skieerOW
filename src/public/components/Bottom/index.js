  ...
  constructor(){
    ...
    this.state = {
      menu:[{name:'公司',list:[{name:'企业介绍',link:'/'},{name:'关于我们',link:'/about'}]},
        {name:'产品',list:[{name:'八爪鱼',link:'http://www.bazhuayu.com/'},{name:'Octoparse',link:'http://www.octoparse.com/'},{name:'云听CEM',link:'http://yunting.ai/'},{name:'数多多',link:'http://www.dataduoduo.com/'}]},
